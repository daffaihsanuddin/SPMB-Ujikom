        ...
        <div class="card bg-primary text-white">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="mb-1">{{ $stats['total_pendaftar'] }}</h4>
    ...
    <div class="col-md-3 mb-3">
        <div class="card bg-warning text-dark">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="mb-1">{{ $stats['menunggu_verifikasi'] }}</h4>
    ...
    <div class="col-md-3 mb-3">
        <div class="card bg-success text-white">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="mb-1">{{ $stats['sudah_bayar'] }}</h4>
    ...
    <div class="col-md-3 mb-3">
        <div class="card bg-info text-white">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="mb-1">Rp {{ number_format($stats['total_pemasukan'], 0, ',', '.') }}</h4>
    ...
    <div class="col-md-6 mb-4">
        <div class="card">
            ...
            <div class="card-body text-center py-4">
                <h1 class="text-success mb-2">Rp {{ number_format($pemasukanHariIni, 0, ',', '.') }}</h1>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    <a href="{{ route('keuangan.verifikasi-pembayaran') }}" class="btn btn-warning btn-lg text-start">
                        <i class="fas fa-money-bill-wave me-2"></i>Verifikasi Pembayaran
                        @if($stats['menunggu_verifikasi'] > 0)
                        <span class="badge bg-danger rounded-pill float-end">{{ $stats['menunggu_verifikasi'] }}</span>
                        @endif
                    </a>
                    <a href="{{ route('keuangan.rekap-keuangan') }}" class="btn btn-info btn-lg text-start">
                        <i class="fas fa-file-invoice-dollar me-2"></i>Rekap Keuangan
                    </a>
                    <a href="{{ route('keuangan.statistik') }}" class="btn btn-success btn-lg text-start">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="text-center mt-3">
                    <a href="{{ route('keuangan.verifikasi-pembayaran') }}" class="btn btn-outline-primary">
