<?php $__env->startSection('title', 'Program Jurusan'); ?>
                ...
                <div class="card card-hover h-100 border-0 shadow-sm">
                    <div class="card-body p-4">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <h4 class="card-title fw-bold text-primary"><?php echo e($item->nama); ?></h4>
                                <p class="card-text text-muted mb-2">
                                    <strong>Kode:</strong> <?php echo e($item->kode); ?>

                                </p>
                                <div class="mb-3">
                                    <small class="text-muted">
                                        <strong>Kuota:</strong> <?php echo e($item->kuota); ?> siswa | 
                                        <strong>Terdaftar:</strong> <?php echo e($item->pendaftar_count); ?> | 
                                        <strong>Sisa:</strong> <?php echo e($sisaKuota); ?>
                                ...
                                <small class="text-muted"><?php echo e(min($persentase, 100)); ?>% terisi</small>
                            </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ppdb\resources\views/jurusan.blade.php ENDPATH**/ ?>