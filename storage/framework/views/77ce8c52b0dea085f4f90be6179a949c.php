...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-12 mb-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="<?php echo e(route('verifikator.index')); ?>" class="btn btn-primary">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('verifikator.riwayat')); ?>">
                        <div class="row g-3">
                            <div class="col-md-2">
                                ...
                                <select class="form-select" id="verifikasi_status" name="verifikasi_status">
                                    ...
                                    <option value="sudah" <?php echo e(request('verifikasi_status') == 'sudah' ? 'selected' : ''); ?>>
                                        Sudah Diverifikasi
                                    </option>
                                    <option value="belum" <?php echo e(request('verifikasi_status') == 'belum' ? 'selected' : ''); ?>>
                                        Belum Diverifikasi
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-2">
                                ...
                                <select class="form-select" id="status" name="status">
                                    ...
                                    <option value="ADM_REJECT" <?php echo e(request('status') == 'ADM_REJECT' ? 'selected' : ''); ?>>TOLAK
                                    </option>
                                    <option value="SUBMIT" <?php echo e(request('status') == 'SUBMIT' ? 'selected' : ''); ?>>MENUNGGU
                                    </option>
                                    <option value="PAID" <?php echo e(request('status') == 'PAID' ? 'selected' : ''); ?>>SUDAH BAYAR
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-2">
            ...
            <div class="card bg-primary text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0"><?php echo e($summary['total_data']); ?></h4>
        ...
        <div class="col-md-3">
            <div class="card bg-success text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0"><?php echo e($summary['sudah_diverifikasi']); ?></h4>
        ...
        <div class="col-md-3">
            <div class="card bg-warning text-dark">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0"><?php echo e($summary['belum_diverifikasi']); ?></h4>
        ...
        <div class="col-md-3">
            <div class="card bg-info text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0"><?php echo e($summary['lulus_administrasi']); ?></h4>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $pendaftar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($item->tgl_verifikasi_adm): ?>
                                        ...
                                        <td><?php echo e($item->user_verifikasi_adm ?? '-'); ?></td>
                                        <td>
                                            <?php if($item->tgl_verifikasi_adm): ?>
                                                <?php echo e($item->tgl_verifikasi_adm->format('d/m/Y H:i')); ?>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <!-- Tombol Detail -->
                                                <a href="<?php echo e(route('verifikator.show.riwayat', $item->id)); ?>"
                                                ...
                                                <?php if(!$item->tgl_verifikasi_adm): ?>
                                                    <a href="<?php echo e(route('verifikator.show', $item->id)); ?>"
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                                        <td colspan="8" class="text-center py-4">
                                            ...
                                            <a href="<?php echo e(route('verifikator.riwayat')); ?>" class="btn btn-primary">
                    ...
                    <?php if($pendaftar->hasPages()): ?>
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            <div class="text-muted">
                                Menampilkan <?php echo e($pendaftar->firstItem() ?? 0); ?> - <?php echo e($pendaftar->lastItem() ?? 0); ?> dari
                                <?php echo e($pendaftar->total()); ?> data
                            </div>
                            <nav>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.verifikator', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ppdb\resources\views/verifikator/riwayat.blade.php ENDPATH**/ ?>