            ...
            <div class="col-lg-4 col-md-6">
                <div class="card card-hover h-100 border-0 shadow-sm">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted mb-3">Tahun {{ $item->tahun }}</p>
                        ...
                        <h5 class="text-success mb-3">Rp {{ number_format($item->biaya_daftar, 0, ',', '.') }}</h5>
                        
                        @if(now()->between($item->tgl_mulai, $item->tgl_selesai))
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card card-hover h-100 border-0 shadow-sm">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="text-muted small">Kode: {{ $item->kode }}</p>
                            <div class="mb-3">
                                <span class="badge bg-info">Kuota: {{ $item->kuota }}</span>
                            </div>
                            <p class="card-text small text-muted">
                                @if($item->kode == 'RPL')
                                    Rekayasa Perangkat Lunak
                                @elseif($item->kode == 'TKJ')
                                    Teknik Komputer Jaringan
                                @elseif($item->kode == 'MM')
                                    Multimedia
                                @elseif($item->kode == 'TKRO')
