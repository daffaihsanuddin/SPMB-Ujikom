...
<?php $__env->startSection('title', 'Verifikasi Pendaftar'); ?>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($item->tanggal_daftar->format('d/m/Y H:i')); ?></td>
                                <td>
                                    <?php
                                        $berkasCount = $item->berkas->count();
                                        $berkasValid = $item->berkas->where('valid', true)->count();
                                    ?>
                                    <span class="badge bg-<?php echo e($berkasCount > 0 ? 'primary' : 'secondary'); ?> badge-verifikasi">
                                        <?php echo e($berkasCount); ?> Berkas
                                    </span>
                                    <?php if($berkasCount > 0): ?>
                                    <span class="badge bg-<?php echo e($berkasValid == $berkasCount ? 'success' : 'warning'); ?> badge-verifikasi">
                                        <?php echo e($berkasValid); ?> Valid
                                    </span>
                                    <?php endif; ?>
                                </td>
                                <td>
...
<?php echo $__env->make('layouts.verifikator', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ppdb\resources\views/verifikator/index.blade.php ENDPATH**/ ?>