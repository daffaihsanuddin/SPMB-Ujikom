<?php $__env->startSection('title', 'Master Data - Gelombang'); ?>
                                ...
                                <?php $__currentLoopData = $gelombang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <?php if($status === 'Aktif' && $sisaHari <= 7): ?>
                                                <span class="badge bg-warning ms-1" title="Hampir berakhir">
                                                    <i class="fas fa-clock me-1"></i><?php echo e($sisaHari); ?> hari
                                                </span>
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e($item->tahun); ?></td>
                                        <td>
                                            <?php echo e($item->tgl_mulai->format('d/m/Y')); ?> -
                                            <?php echo e($item->tgl_selesai->format('d/m/Y')); ?>

                                            <br>
                                            <small class="text-muted">
                                                (<?php echo e($item->tgl_mulai->diffInDays($item->tgl_selesai) + 1); ?> hari)
                                            </small>
                                        </td>
                                        <td>
                                            <strong>Rp <?php echo e(number_format($item->biaya_daftar, 0, ',', '.')); ?></strong>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <span
                                                    class="badge bg-<?php echo e($item->pendaftar_count > 0 ? 'primary' : 'secondary'); ?> me-2">
                                                    <?php echo e($item->pendaftar_count); ?>

                                                </span>
                                                <small class="text-muted">orang</small>
                                            </div>
                                            <?php if($item->pendaftar_count > 0): ?>
                                                <div class="mt-1">
                                                    <small class="text-muted">
                                                        <?php
                                                            $statusCounts = [
                                                        ...
                                                        <span class="badge bg-warning"
                                                            title="Menunggu verifikasi"><?php echo e($statusCounts['SUBMIT']); ?></span>
                                                        <span class="badge bg-success"
                                                            title="Lulus administrasi"><?php echo e($statusCounts['ADM_PASS']); ?></span>
                                                        <span class="badge bg-info"
                                                            title="Sudah bayar"><?php echo e($statusCounts['PAID']); ?></span>
                                                    </small>
                                                </div>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                                    data-bs-target="#editGelombangModal" data-id="<?php echo e($item->id); ?>"
                                                    data-nama="<?php echo e($item->nama); ?>" data-tahun="<?php echo e($item->tahun); ?>"
                                                    data-tgl_mulai="<?php echo e($item->tgl_mulai->format('Y-m-d')); ?>"
                                                    data-tgl_selesai="<?php echo e($item->tgl_selesai->format('Y-m-d')); ?>"
                                                    data-biaya_daftar="<?php echo e($item->biaya_daftar); ?>" title="Edit Gelombang">
                                                    <i class="fas fa-edit"></i>
                                                </button>

                                                <?php if($item->pendaftar_count == 0): ?>
                                                    <form action="<?php echo e(route('admin.gelombang.destroy', $item->id)); ?>" method="POST"
                                                        class="d-inline">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('DELETE'); ?>
                                                        <button type="submit" class="btn btn-danger"
                                                            onclick="return confirm('Hapus gelombang <?php echo e($item->nama); ?>?')"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="tahun" name="tahun" required min="2024"
                                    max="2030" value="<?php echo e(date('Y')); ?>">
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ppdb\resources\views/admin/master/gelombang.blade.php ENDPATH**/ ?>