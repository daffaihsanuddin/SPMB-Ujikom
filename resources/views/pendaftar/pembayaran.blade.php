    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                <a href="{{ route('pendaftar.status') }}" class="btn btn-primary">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="text-center mb-4">
                    ...
                    <h3 class="text-success">Rp {{ number_format($pendaftaran->gelombang->biaya_daftar, 0, ',', '.') }}</h3>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="text-center py-4">
                    ...
                    <p class="text-muted">
                        Diverifikasi pada: {{ $pendaftaran->tgl_verifikasi_payment->format('d/m/Y H:i') }}
                    </p>
                    @endif
                    
                    <a href="{{ route('pendaftar.cetak-kartu') }}" class="btn btn-success mt-2">
                        <i class="fas fa-print me-2"></i>Cetak Kartu Pendaftaran
                    </a>
                </div>
                @elseif($buktiBayar && !$buktiBayar->valid)
                <div class="text-center py-4">
                    <i class="fas fa-clock fa-3x text-warning mb-3"></i>
                    ...
                    @if($buktiBayar->created_at)
                    <p class="text-muted">
                        Diupload pada: {{ $buktiBayar->created_at->format('d/m/Y H:i') }}
                    </p>
                    @endif
                </div>
                @else
            ...
            <div class="card-body">
                <table class="table table-sm">
                    <tr>
                        ...
                        <td>
                            <i class="fas fa-{{ pathinfo($buktiBayar->nama_file, PATHINFO_EXTENSION) === 'pdf' ? 'file-pdf text-danger' : 'image text-primary' }} me-2"></i>
                            {{ $buktiBayar->nama_file }}
                        </td>
                    </tr>
                    <tr>
                    ...
                    @if($buktiBayar->catatan && $buktiBayar->catatan !== 'Bukti Pembayaran')
                    <tr>
                        <td><strong>Catatan</strong></td>
                        <td>{{ $buktiBayar->catatan }}</td>
                    </tr>
                    @endif
                </table>
                
                <div class="text-center">
                    <a href="{{ Storage::url($buktiBayar->url) }}" target="_blank" class="btn btn-outline-primary btn-sm">
