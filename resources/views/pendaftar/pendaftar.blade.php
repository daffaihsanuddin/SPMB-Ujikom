                    ...
                    <div class="col-md-8">
                        ...
                        <p class="mt-2 mb-0 text-muted">
                            ...
                            @elseif($pendaftaran->status === 'ADM_PASS')
                                Selamat! Anda lulus administrasi. Silakan lanjutkan ke pembayaran.
                            @elseif($pendaftaran->status === 'ADM_REJECT')
                                Maaf, Anda tidak lulus administrasi. Silakan hubungi panitia.
                            @elseif($pendaftaran->status === 'PAID')
                                Pembayaran Anda telah diverifikasi. Menunggu proses selanjutnya.
                            @endif
                        </p>
                    </div>
