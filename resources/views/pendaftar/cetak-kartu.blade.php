                    ...
                    <div class="col-md-8">
                        <div class="card border-primary" id="kartuPendaftaran">
                            <div class="card-header bg-primary text-white text-center">
                                ...
                                <p class="mb-0">{{ $sekolahInfo['nama'] }}</p>
                                <p class="mb-0">TAHUN AJARAN {{ $tahunAjaran }}</p>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <table class="table table-borderless table-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>: {{ $pendaftaran->dataSiswa->tmp_lahir ?? '-' }}, {{ $pendaftaran->dataSiswa->tgl_lahir ? \Carbon\Carbon::parse($pendaftaran->dataSiswa->tgl_lahir)->format('d/m/Y') : '-' }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>: {{ $pendaftaran->gelombang->tahun }}</td>
                                            </tr>
                                            <tr>
                            ...
                            <div class="card-footer text-center bg-light">
                                <small class="text-muted">
                                    Kartu ini berlaku untuk mengikuti seleksi SPMB {{ $sekolahInfo['nama'] }} Tahun
                                    {{ $pendaftaran->gelombang->tahun }}
                                </small>
                                <br>
                                <small class="text-muted">
                                    {{ $sekolahInfo['alamat'] }}
                                    <br>
                                    Telp: {{ $sekolahInfo['telp'] }}
                                    </small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endphp
                                <div class="mb-2">
                                    <strong>Berkas Terupload:</strong> {{ $berkasCount }} file
                                </div>
                                <div class="mb-2">
                                    <strong>Berkas Valid:</strong> {{ $berkasValid }} file
                                </div>
                                <div class="progress mb-2" style="height: 8px;">
                                    <div class="progress-bar {{ $berkasCount > 0 ? 'bg-success' : 'bg-warning' }}" 
                                         style="width: {{ $berkasCount > 0 ? ($berkasValid / $berkasCount) * 100 : 0 }}%">
                                    </div>
                                </div>
                            </div>
                        </div>
