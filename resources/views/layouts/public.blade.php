...
<head>
    ...
    <style>
        ...
        body {
            ...
            line-height: 1.6;
            background-image: url('{{ asset("images/BN.jpg") }}');
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('index') ? 'active fw-bold' : '' }}" 
                           href="{{ route('index') }}">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('jurusan') ? 'active fw-bold' : '' }}" 
                           href="{{ route('jurusan') }}">Jurusan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('pendaftaran') ? 'active fw-bold' : '' }}" 
                           href="{{ route('pendaftaran') }}">Pendaftaran</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('faq') ? 'active fw-bold' : '' }}" 
                           href="{{ route('faq') }}">FAQ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('contact') ? 'active fw-bold' : '' }}" 
                           href="{{ route('alamat') }}">Alamat</a>
                    </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{ route('index') }}" class="text-light text-decoration-none">Beranda</a></li>
                        <li><a href="{{ route('jurusan') }}" class="text-light text-decoration-none">Jurusan</a></li>
                        <li><a href="{{ route('pendaftaran') }}" class="text-light text-decoration-none">Pendaftaran</a></li>
