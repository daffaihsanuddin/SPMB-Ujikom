        ...
        <div class="card stat-card bg-warning text-dark">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h4><?php echo e($stats['total_menunggu']); ?></h4>
    ...
    <div class="col-md-3 mb-3">
        <div class="card stat-card bg-success text-white">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h4><?php echo e($stats['total_lulus']); ?></h4>
    ...
    <div class="col-md-3 mb-3">
        <div class="card stat-card bg-danger text-white">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h4><?php echo e($stats['total_tolak']); ?></h4>
    ...
    <div class="col-md-3 mb-3">
        <div class="card stat-card bg-info text-white">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        <h4><?php echo e($stats['total_diverifikasi']); ?></h4>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-2">
                        <a href="<?php echo e(route('verifikator.index')); ?>" class="btn btn-primary w-100">
                            <i class="fas fa-list me-2"></i>Verifikasi Pendaftar
                        </a>
                        <small class="text-muted d-block mt-1">
                            <?php echo e($stats['total_menunggu']); ?> menunggu
                        </small>
                    </div>
                    <div class="col-md-6 mb-2">
                        <a href="<?php echo e(route('verifikator.riwayat')); ?>" class="btn btn-outline-secondary w-100">
                ...
                <div class="row mt-2">
                    <div class="col-md-6 mb-2">
                        <a href="<?php echo e(route('verifikator.export.pdf')); ?>" class="btn btn-outline-success w-100">
...
<?php if(isset($verifikasiHarian) && $verifikasiHarian->count() > 0): ?>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-sm">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $verifikasiHarian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e(\Carbon\Carbon::parse($data->tanggal)->format('d/m/Y')); ?></td>
                                <td class="text-end"><?php echo e($data->total); ?></td>
                                <td class="text-end"><?php echo e($data->lulus); ?></td>
                                <td class="text-end"><?php echo e($data->tolak); ?></td>
                                <td class="text-end">
                                    <?php
                                        $persentase = $data->total > 0 ? round(($data->lulus / $data->total) * 100, 1) : 0;
                                    ?>
                                    <span class="badge bg-<?php echo e($persentase >= 70 ? 'success' : ($persentase >= 50 ? 'warning' : 'danger')); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.verifikator', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ppdb\resources\views/verifikator/dashboard.blade.php ENDPATH**/ ?>