...
@section('content')
    ...
    <form method="POST" action="{{ route('pendaftar.formulir.store') }}" id="pendaftaranForm">
        @csrf
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-lg" id="nik" name="nik"
                                    value="{{ old('nik') }}" required maxlength="20" placeholder="Masukkan NIK">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-lg" id="nama" name="nama"
                                    value="{{ old('nama') }}" required maxlength="120" placeholder="Masukkan nama lengkap">
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="tmp_lahir" name="tmp_lahir"
                                    value="{{ old('tmp_lahir') }}" required maxlength="60" placeholder="Kota tempat lahir">
                            </div>
                            <div class="col-md-4">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="hidden" id="wilayah_id" name="wilayah_id" value="{{ old('wilayah_id') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" id="alamat" name="alamat" rows="8" required
                                    placeholder="Contoh: Jl. Merdeka No. 123, RT 01/RW 02, Kelurahan...">{{ old('alamat') }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_ayah" name="nama_ayah"
                                        value="{{ old('nama_ayah') }}" required maxlength="120"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="pekerjaan_ayah" name="pekerjaan_ayah"
                                        value="{{ old('pekerjaan_ayah') }}" required maxlength="100"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="hp_ayah" name="hp_ayah"
                                        value="{{ old('hp_ayah') }}" required maxlength="20" placeholder="Nomor HP ayah">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_ibu" name="nama_ibu"
                                        value="{{ old('nama_ibu') }}" required maxlength="120"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="pekerjaan_ibu" name="pekerjaan_ibu"
                                        value="{{ old('pekerjaan_ibu') }}" required maxlength="100"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="hp_ibu" name="hp_ibu"
                                        value="{{ old('hp_ibu') }}" required maxlength="20" placeholder="Nomor HP ibu">
                                </div>
                            </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="wali_nama" name="wali_nama"
                                            value="{{ old('wali_nama') }}" maxlength="120" placeholder="Nama lengkap wali">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="wali_hp" class="form-label fw-semibold">HP Wali</label>
                                        <input type="text" class="form-control" id="wali_hp" name="wali_hp"
                                            value="{{ old('wali_hp') }}" maxlength="20" placeholder="Nomor HP wali">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nama_sekolah" name="nama_sekolah"
                                    value="{{ old('nama_sekolah') }}" required maxlength="150"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="kabupaten" name="kabupaten"
                                    value="{{ old('kabupaten') }}" required maxlength="100"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="nilai_rata" name="nilai_rata"
                                    value="{{ old('nilai_rata') }}" step="0.01" min="0" max="100" required
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="jurusan_id" name="jurusan_id" required>
                                    ...
                                    @foreach($jurusan as $item)
                                        ...
                                        @endphp
                                        <option value="{{ $item->id }}" {{ old('jurusan_id') == $item->id ? 'selected' : '' }} {{ !$kuotaTersedia ? 'disabled' : '' }} data-kuota="{{ $item->kuota }}"
                                            data-tersedia="{{ $kuotaTersedia ? 'true' : 'false' }}">
                                            {{ $item->nama }}
                                            <span class="float-end">
                                                <span class="badge {{ $badgeColor }}">{{ $statusKuota }}</span>
                                                (Kuota: {{ $item->kuota }})
                                            </span>
                                        </option>
                                    @endforeach
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="gelombang_id" name="gelombang_id" required>
                                    ...
                                    @foreach($gelombang as $item)
                                        <option value="{{ $item->id }}" {{ old('gelombang_id') == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama }} (Rp {{ number_format($item->biaya_daftar, 0, ',', '.') }})
                                        </option>
                                    @endforeach
                                </select>
                                <div class="form-text mt-1">
    ...
    <script>
        class VirtualScrollWilayah {
            constructor() {
                ...
                this.allData = @json($wilayah); // Data dari controller
