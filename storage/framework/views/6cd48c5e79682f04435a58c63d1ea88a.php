                ...
                <div class="auth-card p-4">
                    ...
                    <?php if(session('warning')): ?>
                        <div class="alert alert-warning">
                            <i class="fas fa-exclamation-triangle me-2"></i><?php echo session('warning'); ?>
                    ...
                    <div class="alert alert-info">
                        ...
                        Kode OTP telah dikirim ke: <strong><?php echo e($registrationData['email']); ?></strong>
                    ...
                    <!-- Form Verifikasi OTP -->
                    <form method="POST" action="<?php echo e(route('verification.verify')); ?>" id="otpForm">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="text-center mt-3">
                        <a href="<?php echo e(route('register')); ?>" class="text-muted" onclick="return confirm('Data registrasi Anda akan hilang. Yakin ingin kembali?')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ppdb\resources\views/auth/verify-otp.blade.php ENDPATH**/ ?>