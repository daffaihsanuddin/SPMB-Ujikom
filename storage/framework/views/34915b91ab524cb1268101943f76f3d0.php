...
<head>
    ...
    <title>Laporan Statistik PPDB - SPMB</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <h2>Tahun Ajaran <?php echo e($tahun); ?>/<?php echo e($tahun + 1); ?></h2>
    ...
    <div class="stat-cards">
        <div class="stat-card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
            <div class="stat-number"><?php echo e(number_format($totalPendaftar, 0)); ?></div>
            <div class="stat-label">Total Pendaftar</div>
        </div>
        <div class="stat-card" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%);">
            <div class="stat-number"><?php echo e(number_format($totalKuota, 0)); ?></div>
            <div class="stat-label">Total Kuota</div>
        </div>
        <div class="stat-card" style="background: linear-gradient(135deg, #f7971e 0%, #ffd200 100%);">
            <div class="stat-number"><?php echo e($rasioPendaftarKuota); ?>%</div>
            <div class="stat-label">Rasio Pendaftar/Kuota</div>
        </div>
        <div class="stat-card" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
            <div class="stat-number"><?php echo e($statistikGelombang->count()); ?></div>
    ...
    <div class="section-title">
        <i class="fas fa-chart-line"></i> Statistik Pendaftaran per Bulan (Tahun <?php echo e($tahun); ?>)
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            ?>
            <?php $__currentLoopData = $bulananLengkap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $persentase = $totalBulanan > 0 ? round(($item['total'] / $totalBulanan) * 100, 1) : 0;
            ?>
            <tr>
                <td><strong><?php echo e($item['nama_bulan']); ?></strong></td>
                <td class="text-center"><?php echo e($item['total']); ?></td>
                <td class="text-center"><?php echo e($persentase); ?>%</td>
                <td>
                    <div class="progress">
                        <div class="progress-bar" style="width: <?php echo e($persentase); ?>%; background-color: #3498db;">
            ...
            <tr style="background-color: #e3f2fd; font-weight: bold;">
                ...
                <td class="text-center"><strong><?php echo e($totalBulanan); ?></strong></td>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center <?php echo e($tersisa == 0 ? 'text-danger' : 'text-success'); ?>">
                    <?php echo e($tersisa); ?>

                </td>
                <td class="text-center">
                    <span class="badge badge-<?php echo e($rasio >= 100 ? 'danger' : ($rasio >= 80 ? 'warning' : 'success')); ?>">
                        <?php echo e($rasio); ?>%
                    </span>
                </td>
                <td>
                    <div class="progress">
                        <div class="progress-bar" style="width: <?php echo e(min($rasio, 100)); ?>%; background-color: <?php echo e($progressColor); ?>;">
                            <?php echo e(min($rasio, 100)); ?>%
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr style="background-color: #2c3e50; color: white; font-weight: bold;">
                ...
                <td class="text-center"><strong><?php echo e($totalPendaftarJurusan); ?></strong></td>
                <td class="text-center"><strong><?php echo e($totalKuotaJurusan); ?></strong></td>
                <td class="text-center"><strong><?php echo e(max(0, $totalKuotaJurusan - $totalPendaftarJurusan)); ?></strong></td>
                <td class="text-center"><strong><?php echo e($totalRasio); ?>%</strong></td>
                <td></td>
            </tr>
        </tbody>
    </table>
    ...
    <table style="width: 60%; margin: 0 auto;">
        ...
        <tbody>
            ...
            ?>
            <tr>
                <td><?php echo e($statusInfo['label']); ?></td>
                <td class="text-center"><?php echo e($item->total); ?></td>
                <td class="text-center"><?php echo e($persentase); ?>%</td>
                <td>
                    <div class="progress">
                        <div class="progress-bar" style="width: <?php echo e($persentase); ?>%; background-color: <?php echo e($statusInfo['color']); ?>;">
                            <?php echo e($persentase); ?>%
                        </div>
                    </div>
                </td>
            ...
            <tr style="background-color: #e3f2fd; font-weight: bold;">
                <td><strong>TOTAL</strong></td>
                <td class="text-center"><strong><?php echo e($totalStatus); ?></strong></td>
                <td class="text-center"><strong>100%</strong></td>
                <td></td>
            </tr>
        </tbody>
    ...
    <div class="footer">
        ...
        <p>© <?php echo e(date('Y')); ?> SPMB Online - Semua Hak Dilindungi Undang-Undang</p>
    </div>
</body>
</html><?php /**PATH C:\laragon\www\ppdb\resources\views/kepsek/export/statistik.blade.php ENDPATH**/ ?>